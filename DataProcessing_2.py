...
col_tmp=X_train.describe().columns

X_train=X_train[col_tmp]

X_train.to_csv("./dataset/x_train_tmp.csv", encoding='utf-8')
...
# X_train.to_csv("./dataset/x_train_tmp.csv", encoding='utf-8')
# X_test.to_csv("./dataset/x_test_tmp.csv", encoding='utf-8')
